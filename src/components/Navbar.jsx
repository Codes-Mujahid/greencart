  ...
  return (
    <div className='flex flex-col gap-4 sm:flex-row justify-between items-center px-8 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] py-4 border-b border-b-gray-300 '>
        ...
        <div className='flex justify-between items-center gap-8'>
            ...
            <div className='flex relative shrink-0 cursor-pointer'>
            ...
            <button className='hidden md:block px-10 py-2 rounded-full bg-primary text-white font-medium cursor-pointer' type="button">Login</button>
        ...
        <div className={`absolute overflow-hidden top-0 right-0 bottom-0 transition-all bg-gray-200 ${menu? 'w-full': 'w-0'}`}>
            ...
            <div className='flex justify-center mt-4'>
                <button className='px-15 py-2 bg-primary text-white font-medium cursor-pointer'type="button">Login</button>
            </div>
        </div>
